...
app.get('/agendamento/disponivel', async (req, resp) => {
    try {
...
app.get('/agendamento/funcionario/:id', async (req, resp) => {
    try {
        let r = await db.infod_leo_agendamento.findAll({ 
...
app.get('/email/buscarbairro', async (req, resp) => {
    try{
...
app.post('/email/enviar', async (req, resp) => {
    try {
...
app.post('/email/esqueciASenha', async (req, resp) => {
...
app.post('/email/validarCodigo', async (req, resp) => {
  ...
  app.put('/email/resetSenha', async (req, resp) => {
    const user = await db.infod_leo_cliente.findOne({
      where: {
        ds_email: req.body.email   
      }
...
app.post('/funcionario/entrar', async (req, resp) => {
    try {
